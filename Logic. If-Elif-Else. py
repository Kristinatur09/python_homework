...
# 31.4 Создать переменную currency_result со значением 0:
 ...
 # 31.6 Сделать elif с остальными валютами:
        	  ...
        	  print(target_currency_amount, uah_item, '=', currency_result, chf_item)
      elif target_currency == 'rub':
        	  currency_result = target_currency_amount / usd_rub_rate
        	  print(target_currency_amount, uah_item, '=', currency_result, rub_item)
      elif target_currency == 'byn':
        		currency_result = target_currency_amount / usd_byn_rate
        		print(target_currency_amount, uah_item, '=', currency_result, byn_item)
…
